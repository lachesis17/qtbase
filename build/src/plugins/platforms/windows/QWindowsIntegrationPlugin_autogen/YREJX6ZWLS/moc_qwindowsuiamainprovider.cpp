...
#include "../../../../../../../src/plugins/platforms/windows/uiautomation/qwindowsuiamainprovider.h"
...
struct qt_meta_stringdata_CLASSQWindowsUiaMainProviderENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQWindowsUiaMainProviderENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQWindowsUiaMainProviderENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QWindowsUiaMainProvider::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQWindowsUiaMainProviderENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQWindowsUiaMainProviderENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQWindowsUiaMainProviderENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QWindowsUiaMainProvider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQWindowsUiaMainProviderENDCLASS.stringdata0))
