...
constexpr auto qt_meta_stringdata_CLASSQTextObjectENDCLASS = QtMocHelpers::stringData(
    "QTextObject"
);
...
constexpr auto qt_meta_stringdata_CLASSQTextBlockGroupENDCLASS = QtMocHelpers::stringData(
    "QTextBlockGroup"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
constexpr auto qt_meta_stringdata_CLASSQTextFrameENDCLASS = QtMocHelpers::stringData(
    "QTextFrame"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
