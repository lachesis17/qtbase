...
struct qt_meta_stringdata_CLASSQMovieENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQMovieENDCLASS = QtMocHelpers::stringData(
    "QMovie",
    "started",
    "",
    "resized",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQMovieENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QMovie::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQMovieENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQMovieENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQMovieENDCLASS_t,
        // property 'speed'
...
void QMovie::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QMovie::started; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QMovie::resized; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QMovie::updated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QMovie::stateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QMovie::error; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QMovie::*)();
            if (_t _q_method = &QMovie::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QMovie::frameChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
void *QMovie::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQMovieENDCLASS.stringdata0))
