...
constexpr auto qt_meta_stringdata_CLASSQPointingDeviceUniqueIdENDCLASS = QtMocHelpers::stringData(
...
constexpr auto qt_meta_stringdata_CLASSQPointingDeviceENDCLASS = QtMocHelpers::stringData(
    "QPointingDevice",
    "grabChanged",
    "",
    "grabber",
