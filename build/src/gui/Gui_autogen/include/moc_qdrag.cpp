...
struct qt_meta_stringdata_CLASSQDragENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQDragENDCLASS = QtMocHelpers::stringData(
    "QDrag",
    "actionChanged",
    "",
    "Qt::DropAction",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQDragENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QDrag::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQDragENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQDragENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQDragENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QDrag, std::true_type>,
...
void QDrag::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QDrag::actionChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QDrag::targetChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QDrag::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQDragENDCLASS.stringdata0))
