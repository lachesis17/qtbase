...
struct qt_meta_stringdata_CLASSQPaintDeviceWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQPaintDeviceWindowENDCLASS = QtMocHelpers::stringData(
    "QPaintDeviceWindow",
    "update",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQPaintDeviceWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QPaintDeviceWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWindow::staticMetaObject>(),
    qt_meta_stringdata_CLASSQPaintDeviceWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQPaintDeviceWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQPaintDeviceWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QPaintDeviceWindow, std::true_type>,
        // method 'update'
...
void *QPaintDeviceWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQPaintDeviceWindowENDCLASS.stringdata0))
