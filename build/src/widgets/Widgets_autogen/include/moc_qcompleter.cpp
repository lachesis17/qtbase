...
struct qt_meta_stringdata_CLASSQCompleterENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQCompleterENDCLASS = QtMocHelpers::stringData(
    "QCompleter",
    "activated",
    "",
    "text",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQCompleterENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QCompleter::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQCompleterENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQCompleterENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQCompleterENDCLASS_t,
...
void QCompleter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QCompleter::activated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _t = void (QCompleter::*)(const QString & );
            if (_t _q_method = &QCompleter::highlighted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QCompleter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQCompleterENDCLASS.stringdata0))
