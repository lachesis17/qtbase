...
struct qt_meta_stringdata_CLASSQCalendarWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQCalendarWidgetENDCLASS = QtMocHelpers::stringData(
    "QCalendarWidget",
    "selectionChanged",
    "",
    "clicked",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQCalendarWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QCalendarWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQCalendarWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQCalendarWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQCalendarWidgetENDCLASS_t,
...
void QCalendarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QCalendarWidget::selectionChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QCalendarWidget::*)(QDate );
            if (_t _q_method = &QCalendarWidget::clicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QCalendarWidget::*)(QDate );
            if (_t _q_method = &QCalendarWidget::activated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QCalendarWidget::currentPageChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *QCalendarWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQCalendarWidgetENDCLASS.stringdata0))
