...
struct qt_meta_stringdata_CLASSQCompletionModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQCompletionModelENDCLASS = QtMocHelpers::stringData(
    "QCompletionModel",
    "rowsAdded",
    "",
    "invalidate",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQCompletionModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QCompletionModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQCompletionModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQCompletionModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQCompletionModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QCompletionModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QCompletionModel::rowsAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QCompletionModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQCompletionModelENDCLASS.stringdata0))
