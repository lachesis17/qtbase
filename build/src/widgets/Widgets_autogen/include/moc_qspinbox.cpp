...
constexpr auto qt_meta_stringdata_CLASSQSpinBoxENDCLASS = QtMocHelpers::stringData(
    "QSpinBox",
    "valueChanged",
    "",
    "textChanged",
...
constexpr auto qt_meta_stringdata_CLASSQDoubleSpinBoxENDCLASS = QtMocHelpers::stringData(
    "QDoubleSpinBox",
    "valueChanged",
    "",
    "textChanged",
