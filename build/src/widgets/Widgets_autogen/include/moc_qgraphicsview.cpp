...
struct qt_meta_stringdata_CLASSQGraphicsViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQGraphicsViewENDCLASS = QtMocHelpers::stringData(
    "QGraphicsView",
    "rubberBandChanged",
    "",
    "viewportRect",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQGraphicsViewENDCLASS[] = {
...
Q_CONSTINIT static const QMetaObject::SuperData qt_meta_extradata_CLASSQGraphicsViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QGraphicsView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQGraphicsViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQGraphicsViewENDCLASS,
    qt_static_metacall,
    qt_meta_extradata_CLASSQGraphicsViewENDCLASS,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQGraphicsViewENDCLASS_t,
...
void QGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QGraphicsView::rubberBandChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QGraphicsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQGraphicsViewENDCLASS.stringdata0))
