...
struct qt_meta_stringdata_CLASSQLineEditIconButtonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQLineEditIconButtonENDCLASS = QtMocHelpers::stringData(
    "QLineEditIconButton",
    "updateCursor",
    "",
    "onAnimationFinished",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQLineEditIconButtonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QLineEditIconButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQLineEditIconButtonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQLineEditIconButtonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQLineEditIconButtonENDCLASS_t,
        // property 'opacity'
...
void *QLineEditIconButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQLineEditIconButtonENDCLASS.stringdata0))
