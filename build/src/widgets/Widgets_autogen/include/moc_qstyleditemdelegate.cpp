...
struct qt_meta_stringdata_CLASSQStyledItemDelegateENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQStyledItemDelegateENDCLASS = QtMocHelpers::stringData(
    "QStyledItemDelegate"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQStyledItemDelegateENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QStyledItemDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQStyledItemDelegateENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQStyledItemDelegateENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQStyledItemDelegateENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QStyledItemDelegate, std::true_type>
    >,
    nullptr
} };
...
void *QStyledItemDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQStyledItemDelegateENDCLASS.stringdata0))
