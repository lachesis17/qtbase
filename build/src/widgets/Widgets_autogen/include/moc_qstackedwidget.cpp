...
struct qt_meta_stringdata_CLASSQStackedWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQStackedWidgetENDCLASS = QtMocHelpers::stringData(
    "QStackedWidget",
    "currentChanged",
    "",
    "widgetRemoved",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQStackedWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QStackedWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_CLASSQStackedWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQStackedWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQStackedWidgetENDCLASS_t,
        // property 'currentIndex'
        QtPrivate::TypeAndForceComplete<int, std::true_type>,
        // property 'count'
        QtPrivate::TypeAndForceComplete<int, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QStackedWidget, std::true_type>,
...
void QStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QStackedWidget::currentChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QStackedWidget::*)(int );
            if (_t _q_method = &QStackedWidget::widgetRemoved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QStackedWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQStackedWidgetENDCLASS.stringdata0))
