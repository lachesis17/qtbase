...
struct qt_meta_stringdata_CLASSQProgressBarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQProgressBarENDCLASS = QtMocHelpers::stringData(
    "QProgressBar",
    "valueChanged",
    "",
    "value",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQProgressBarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QProgressBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQProgressBarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQProgressBarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQProgressBarENDCLASS_t,
        // property 'minimum'
...
void QProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QProgressBar::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QProgressBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQProgressBarENDCLASS.stringdata0))
