...
struct qt_meta_stringdata_CLASSQGraphicsSceneIndexENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQGraphicsSceneIndexENDCLASS = QtMocHelpers::stringData(
    "QGraphicsSceneIndex",
    "updateSceneRect",
    "",
    "rect"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQGraphicsSceneIndexENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QGraphicsSceneIndex::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSQGraphicsSceneIndexENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQGraphicsSceneIndexENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQGraphicsSceneIndexENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QGraphicsSceneIndex, std::true_type>,
...
void *QGraphicsSceneIndex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQGraphicsSceneIndexENDCLASS.stringdata0))
