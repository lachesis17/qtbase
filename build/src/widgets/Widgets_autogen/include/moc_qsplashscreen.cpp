...
struct qt_meta_stringdata_CLASSQSplashScreenENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQSplashScreenENDCLASS = QtMocHelpers::stringData(
    "QSplashScreen",
    "messageChanged",
    "",
    "message",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQSplashScreenENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QSplashScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQSplashScreenENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQSplashScreenENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQSplashScreenENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QSplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QSplashScreen::messageChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QSplashScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQSplashScreenENDCLASS.stringdata0))
