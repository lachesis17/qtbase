...
struct qt_meta_stringdata_CLASSQMdiAreaENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQMdiAreaENDCLASS = QtMocHelpers::stringData(
    "QMdiArea",
    "subWindowActivated",
    "",
    "QMdiSubWindow*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQMdiAreaENDCLASS[] = {
...
Q_CONSTINIT static const QMetaObject::SuperData qt_meta_extradata_CLASSQMdiAreaENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QMdiArea::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQMdiAreaENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQMdiAreaENDCLASS,
    qt_static_metacall,
    qt_meta_extradata_CLASSQMdiAreaENDCLASS,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQMdiAreaENDCLASS_t,
        // property 'background'
...
void QMdiArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QMdiArea::subWindowActivated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QMdiArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQMdiAreaENDCLASS.stringdata0))
