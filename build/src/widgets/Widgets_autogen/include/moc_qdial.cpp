...
struct qt_meta_stringdata_CLASSQDialENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQDialENDCLASS = QtMocHelpers::stringData(
    "QDial",
    "setNotchesVisible",
    "",
    "visible",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQDialENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QDial::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQDialENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQDialENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQDialENDCLASS_t,
        // property 'wrapping'
...
void *QDial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQDialENDCLASS.stringdata0))
