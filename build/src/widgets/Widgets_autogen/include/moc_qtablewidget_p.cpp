...
constexpr auto qt_meta_stringdata_CLASSQTableWidgetMimeDataENDCLASS = QtMocHelpers::stringData(
...
constexpr auto qt_meta_stringdata_CLASSQTableModelENDCLASS = QtMocHelpers::stringData(
    "QTableModel"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
