...
constexpr auto qt_meta_stringdata_CLASSQUrlModelENDCLASS = QtMocHelpers::stringData(
    "QUrlModel",
    "dataChanged",
    "",
    "QModelIndex",
...
constexpr auto qt_meta_stringdata_CLASSQSidebarENDCLASS = QtMocHelpers::stringData(
    "QSidebar",
    "goToUrl",
    "",
    "url",
