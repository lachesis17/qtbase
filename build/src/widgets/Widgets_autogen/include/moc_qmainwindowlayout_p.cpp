...
constexpr auto qt_meta_stringdata_CLASSQDockWidgetGroupWindowENDCLASS = QtMocHelpers::stringData(
...
constexpr auto qt_meta_stringdata_CLASSQMainWindowLayoutENDCLASS = QtMocHelpers::stringData(
    "QMainWindowLayout",
    "updateGapIndicator",
    "",
    "tabChanged",
