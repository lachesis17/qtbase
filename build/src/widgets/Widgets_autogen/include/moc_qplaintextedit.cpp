...
constexpr auto qt_meta_stringdata_CLASSQPlainTextEditENDCLASS = QtMocHelpers::stringData(
    "QPlainTextEdit",
    "textChanged",
    "",
    "undoAvailable",
...
constexpr auto qt_meta_stringdata_CLASSQPlainTextDocumentLayoutENDCLASS = QtMocHelpers::stringData(
