...
struct qt_meta_stringdata_CLASSQUndoViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQUndoViewENDCLASS = QtMocHelpers::stringData(
    "QUndoView",
    "setStack",
    "",
    "QUndoStack*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQUndoViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QUndoView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQUndoViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQUndoViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQUndoViewENDCLASS_t,
        // property 'emptyLabel'
...
void *QUndoView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQUndoViewENDCLASS.stringdata0))
