...
struct qt_meta_stringdata_CLASSQDateTimeEditENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQDateTimeEditENDCLASS = QtMocHelpers::stringData(
    "QDateTimeEdit",
    "dateTimeChanged",
    "",
    "dateTime",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQDateTimeEditENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QDateTimeEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQDateTimeEditENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQDateTimeEditENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQDateTimeEditENDCLASS_t,
        // property 'dateTime'
...
void QDateTimeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QDateTimeEdit::dateTimeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QDateTimeEdit::*)(QTime );
            if (_t _q_method = &QDateTimeEdit::timeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QDateTimeEdit::*)(QDate );
            if (_t _q_method = &QDateTimeEdit::dateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QDateTimeEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQDateTimeEditENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQTimeEditENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQTimeEditENDCLASS = QtMocHelpers::stringData(
    "QTimeEdit",
    "userTimeChanged",
    "",
    "time"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQTimeEditENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QTimeEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQTimeEditENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQTimeEditENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQTimeEditENDCLASS_t,
        // property 'time'
        QtPrivate::TypeAndForceComplete<QTime, std::true_type>,
        // Q_OBJECT / Q_GADGET
...
void QTimeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QTimeEdit::*)(QTime );
            if (_t _q_method = &QTimeEdit::userTimeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQTimeEditENDCLASS.stringdata0))
        return static_cast<void*>(this);
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQDateEditENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQDateEditENDCLASS = QtMocHelpers::stringData(
    "QDateEdit",
    "userDateChanged",
    "",
    "date"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQDateEditENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QDateEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QDateTimeEdit::staticMetaObject>(),
    qt_meta_stringdata_CLASSQDateEditENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQDateEditENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQDateEditENDCLASS_t,
        // property 'date'
        QtPrivate::TypeAndForceComplete<QDate, std::true_type>,
        // Q_OBJECT / Q_GADGET
...
void QDateEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QDateEdit::*)(QDate );
            if (_t _q_method = &QDateEdit::userDateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQDateEditENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QDateTimeEdit::qt_metacast(_clname);
}
