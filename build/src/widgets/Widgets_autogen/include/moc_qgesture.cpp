...
constexpr auto qt_meta_stringdata_CLASSQGestureENDCLASS = QtMocHelpers::stringData(
    "QGesture",
    "state",
    "Qt::GestureState",
    "gestureType",
...
constexpr auto qt_meta_stringdata_CLASSQPanGestureENDCLASS = QtMocHelpers::stringData(
    "QPanGesture",
    "lastOffset",
    "offset",
    "delta",
...
constexpr auto qt_meta_stringdata_CLASSQPinchGestureENDCLASS = QtMocHelpers::stringData(
    "QPinchGesture",
    "totalChangeFlags",
    "ChangeFlags",
    "changeFlags",
...
constexpr auto qt_meta_stringdata_CLASSQSwipeGestureENDCLASS = QtMocHelpers::stringData(
    "QSwipeGesture",
    "horizontalDirection",
    "SwipeDirection",
    "verticalDirection",
...
constexpr auto qt_meta_stringdata_CLASSQTapGestureENDCLASS = QtMocHelpers::stringData(
    "QTapGesture",
    "position"
);
#else  // !QT_MOC_HAS_STRINGDATA
...
constexpr auto qt_meta_stringdata_CLASSQTapAndHoldGestureENDCLASS = QtMocHelpers::stringData(
    "QTapAndHoldGesture",
    "position"
);
#else  // !QT_MOC_HAS_STRINGDATA
