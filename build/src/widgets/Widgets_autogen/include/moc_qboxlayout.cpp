...
constexpr auto qt_meta_stringdata_CLASSQBoxLayoutENDCLASS = QtMocHelpers::stringData(
    "QBoxLayout"
);
...
constexpr auto qt_meta_stringdata_CLASSQHBoxLayoutENDCLASS = QtMocHelpers::stringData(
    "QHBoxLayout"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
constexpr auto qt_meta_stringdata_CLASSQVBoxLayoutENDCLASS = QtMocHelpers::stringData(
    "QVBoxLayout"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
