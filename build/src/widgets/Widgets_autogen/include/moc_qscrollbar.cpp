...
struct qt_meta_stringdata_CLASSQScrollBarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQScrollBarENDCLASS = QtMocHelpers::stringData(
    "QScrollBar"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQScrollBarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QScrollBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQScrollBarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQScrollBarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQScrollBarENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QScrollBar, std::true_type>
    >,
    nullptr
} };
...
void *QScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQScrollBarENDCLASS.stringdata0))
