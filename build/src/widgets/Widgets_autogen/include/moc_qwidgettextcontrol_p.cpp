...
constexpr auto qt_meta_stringdata_CLASSQWidgetTextControlENDCLASS = QtMocHelpers::stringData(
    "QWidgetTextControl",
    "textChanged",
    "",
    "undoAvailable",
...
constexpr auto qt_meta_stringdata_CLASSQUnicodeControlCharacterMenuENDCLASS = QtMocHelpers::stringData(
