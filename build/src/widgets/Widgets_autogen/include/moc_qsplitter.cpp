...
constexpr auto qt_meta_stringdata_CLASSQSplitterENDCLASS = QtMocHelpers::stringData(
    "QSplitter",
    "splitterMoved",
    "",
    "pos",
...
constexpr auto qt_meta_stringdata_CLASSQSplitterHandleENDCLASS = QtMocHelpers::stringData(
    "QSplitterHandle"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
