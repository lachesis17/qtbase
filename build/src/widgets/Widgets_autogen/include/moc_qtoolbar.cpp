...
struct qt_meta_stringdata_CLASSQToolBarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQToolBarENDCLASS = QtMocHelpers::stringData(
    "QToolBar",
    "actionTriggered",
    "",
    "QAction*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQToolBarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QToolBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQToolBarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQToolBarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQToolBarENDCLASS_t,
        // property 'movable'
...
void QToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QToolBar::actionTriggered; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QToolBar::movableChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QToolBar::allowedAreasChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QToolBar::orientationChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QToolBar::iconSizeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QToolBar::toolButtonStyleChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(bool );
            if (_t _q_method = &QToolBar::topLevelChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(bool );
            if (_t _q_method = &QToolBar::visibilityChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
void *QToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQToolBarENDCLASS.stringdata0))
