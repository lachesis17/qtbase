...
struct qt_meta_stringdata_CLASSQToolBarLayoutENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQToolBarLayoutENDCLASS = QtMocHelpers::stringData(
    "QToolBarLayout",
    "setExpanded",
    "",
    "b"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQToolBarLayoutENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QToolBarLayout::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQToolBarLayoutENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQToolBarLayoutENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQToolBarLayoutENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QToolBarLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQToolBarLayoutENDCLASS.stringdata0))
