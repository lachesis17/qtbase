...
constexpr auto qt_meta_stringdata_CLASSQGraphicsObjectENDCLASS = QtMocHelpers::stringData(
    "QGraphicsObject",
    "parentChanged",
    "",
    "opacityChanged",
...
constexpr auto qt_meta_stringdata_CLASSQGraphicsTextItemENDCLASS = QtMocHelpers::stringData(
    "QGraphicsTextItem",
    "linkActivated",
    "",
    "linkHovered"
