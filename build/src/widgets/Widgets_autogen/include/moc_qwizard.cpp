...
struct qt_meta_stringdata_CLASSQWizardENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQWizardENDCLASS = QtMocHelpers::stringData(
    "QWizard",
    "currentIdChanged",
    "",
    "id",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQWizardENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QWizard::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQWizardENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQWizardENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQWizardENDCLASS_t,
...
void QWizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QWizard::currentIdChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QWizard::helpRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QWizard::*)(int );
            if (_t _q_method = &QWizard::customButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QWizard::*)(int );
            if (_t _q_method = &QWizard::pageAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QWizard::*)(int );
            if (_t _q_method = &QWizard::pageRemoved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
void *QWizard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQWizardENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQWizardPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQWizardPageENDCLASS = QtMocHelpers::stringData(
    "QWizardPage",
    "completeChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQWizardPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QWizardPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQWizardPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQWizardPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQWizardPageENDCLASS_t,
        // property 'title'
...
void QWizardPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QWizardPage::completeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQWizardPageENDCLASS.stringdata0))
        return static_cast<void*>(this);
