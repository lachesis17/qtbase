...
struct qt_meta_stringdata_CLASSQTextBrowserENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQTextBrowserENDCLASS = QtMocHelpers::stringData(
    "QTextBrowser",
    "backwardAvailable",
    "",
    "forwardAvailable",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQTextBrowserENDCLASS[] = {
...
Q_CONSTINIT static const QMetaObject::SuperData qt_meta_extradata_CLASSQTextBrowserENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QTextBrowser::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQTextBrowserENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQTextBrowserENDCLASS,
    qt_static_metacall,
    qt_meta_extradata_CLASSQTextBrowserENDCLASS,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQTextBrowserENDCLASS_t,
        // property 'source'
...
void QTextBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QTextBrowser::backwardAvailable; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(bool );
            if (_t _q_method = &QTextBrowser::forwardAvailable; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QTextBrowser::historyChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QTextBrowser::sourceChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(const QUrl & );
            if (_t _q_method = &QTextBrowser::highlighted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(const QUrl & );
            if (_t _q_method = &QTextBrowser::anchorClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
void *QTextBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQTextBrowserENDCLASS.stringdata0))
