...
struct qt_meta_stringdata_CLASSQCalendarPopupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQCalendarPopupENDCLASS = QtMocHelpers::stringData(
    "QCalendarPopup",
    "activated",
    "",
    "date",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQCalendarPopupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QCalendarPopup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQCalendarPopupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQCalendarPopupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQCalendarPopupENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QCalendarPopup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QCalendarPopup::*)(QDate );
            if (_t _q_method = &QCalendarPopup::activated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QCalendarPopup::*)(QDate );
            if (_t _q_method = &QCalendarPopup::newDateSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QCalendarPopup::*)(QDate );
            if (_t _q_method = &QCalendarPopup::hidingCalendar; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QCalendarPopup::resetButton; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *QCalendarPopup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQCalendarPopupENDCLASS.stringdata0))
