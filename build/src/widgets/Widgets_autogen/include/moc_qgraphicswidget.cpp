...
struct qt_meta_stringdata_CLASSQGraphicsWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQGraphicsWidgetENDCLASS = QtMocHelpers::stringData(
    "QGraphicsWidget",
    "geometryChanged",
    "",
    "layoutChanged",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQGraphicsWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QGraphicsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQGraphicsWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQGraphicsWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQGraphicsWidgetENDCLASS_t,
        // property 'palette'
...
void QGraphicsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QGraphicsWidget::geometryChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QGraphicsWidget::*)();
            if (_t _q_method = &QGraphicsWidget::layoutChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QGraphicsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQGraphicsWidgetENDCLASS.stringdata0))
