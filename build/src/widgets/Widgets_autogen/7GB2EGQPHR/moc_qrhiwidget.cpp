...
struct qt_meta_stringdata_CLASSQRhiWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQRhiWidgetENDCLASS = QtMocHelpers::stringData(
    "QRhiWidget",
    "frameSubmitted",
    "",
    "renderFailed",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQRhiWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QRhiWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQRhiWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQRhiWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQRhiWidgetENDCLASS_t,
...
void QRhiWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QRhiWidget::*)();
            if (_t _q_method = &QRhiWidget::frameSubmitted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QRhiWidget::*)();
            if (_t _q_method = &QRhiWidget::renderFailed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QRhiWidget::*)(int );
            if (_t _q_method = &QRhiWidget::sampleCountChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QRhiWidget::*)(TextureFormat );
            if (_t _q_method = &QRhiWidget::colorBufferFormatChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QRhiWidget::*)(const QSize & );
            if (_t _q_method = &QRhiWidget::fixedColorBufferSizeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QRhiWidget::*)(bool );
            if (_t _q_method = &QRhiWidget::mirrorVerticallyChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
void *QRhiWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQRhiWidgetENDCLASS.stringdata0))
