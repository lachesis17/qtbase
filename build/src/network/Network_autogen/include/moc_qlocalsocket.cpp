...
struct qt_meta_stringdata_CLASSQLocalSocketENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQLocalSocketENDCLASS = QtMocHelpers::stringData(
    "QLocalSocket",
    "connected",
    "",
    "disconnected",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQLocalSocketENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QLocalSocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQLocalSocketENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQLocalSocketENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQLocalSocketENDCLASS_t,
...
void QLocalSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QLocalSocket::connected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QLocalSocket::*)();
            if (_t _q_method = &QLocalSocket::disconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QLocalSocket::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QLocalSocket::stateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *QLocalSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQLocalSocketENDCLASS.stringdata0))
