...
struct qt_meta_stringdata_CLASSQNetworkRequestENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkRequestENDCLASS = QtMocHelpers::stringData(
    "QNetworkRequest",
    "KnownHeaders",
    "ContentTypeHeader",
    "ContentLengthHeader",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkRequestENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkRequest::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_CLASSQNetworkRequestENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkRequestENDCLASS,
    nullptr,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkRequestENDCLASS_t,
        // enum 'KnownHeaders'
