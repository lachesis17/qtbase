...
struct qt_meta_stringdata_CLASSQAbstractSocketENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQAbstractSocketENDCLASS = QtMocHelpers::stringData(
    "QAbstractSocket",
    "hostFound",
    "",
    "connected",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQAbstractSocketENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QAbstractSocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQAbstractSocketENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQAbstractSocketENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQAbstractSocketENDCLASS_t,
        // enum 'SocketType'
...
void QAbstractSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QAbstractSocket::hostFound; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QAbstractSocket::*)();
            if (_t _q_method = &QAbstractSocket::connected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QAbstractSocket::*)();
            if (_t _q_method = &QAbstractSocket::disconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QAbstractSocket::stateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QAbstractSocket::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QAbstractSocket::proxyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
void *QAbstractSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQAbstractSocketENDCLASS.stringdata0))
