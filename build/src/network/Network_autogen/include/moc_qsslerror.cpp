...
struct qt_meta_stringdata_CLASSQSslErrorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQSslErrorENDCLASS = QtMocHelpers::stringData(
    "QSslError",
    "SslError",
    "NoError",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQSslErrorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QSslError::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_CLASSQSslErrorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQSslErrorENDCLASS,
    nullptr,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQSslErrorENDCLASS_t,
        // enum 'SslError'
