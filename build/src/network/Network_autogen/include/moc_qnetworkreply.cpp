...
struct qt_meta_stringdata_CLASSQNetworkReplyENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkReplyENDCLASS = QtMocHelpers::stringData(
    "QNetworkReply",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkReplyENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkReply::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkReplyENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkReplyENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkReplyENDCLASS_t,
        // enum 'NetworkError'
...
void QNetworkReply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QNetworkReply::socketStartedConnecting; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)();
            if (_t _q_method = &QNetworkReply::requestSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)();
            if (_t _q_method = &QNetworkReply::metaDataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)();
            if (_t _q_method = &QNetworkReply::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkReply::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)();
            if (_t _q_method = &QNetworkReply::encrypted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)(const QList<QSslError> & );
            if (_t _q_method = &QNetworkReply::sslErrors; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)(QSslPreSharedKeyAuthenticator * );
            if (_t _q_method = &QNetworkReply::preSharedKeyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkReply::redirected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)();
            if (_t _q_method = &QNetworkReply::redirectAllowed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkReply::uploadProgress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (QNetworkReply::*)(qint64 , qint64 );
            if (_t _q_method = &QNetworkReply::downloadProgress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 11;
                return;
            }
        }
...
void *QNetworkReply::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkReplyENDCLASS.stringdata0))
