...
struct qt_meta_stringdata_CLASSQSslENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQSslENDCLASS = QtMocHelpers::stringData(
    "QSsl",
    "KeyType",
    "PrivateKey",
    "PublicKey",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQSslENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QSsl::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_CLASSQSslENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQSslENDCLASS,
    nullptr,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQSslENDCLASS_t,
        // enum 'KeyType'
