...
struct qt_meta_stringdata_CLASSQNetworkAccessBackendENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkAccessBackendENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkAccessBackendENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkAccessBackend::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkAccessBackendENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkAccessBackendENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkAccessBackendENDCLASS_t,
        // enum 'TargetType'
...
void *QNetworkAccessBackend::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkAccessBackendENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQNetworkAccessBackendFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkAccessBackendFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkAccessBackendFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkAccessBackendFactory::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSQNetworkAccessBackendFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkAccessBackendFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkAccessBackendFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkAccessBackendFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
