...
struct qt_meta_stringdata_CLASSQNetworkReplyHttpImplENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkReplyHttpImplENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkReplyHttpImplENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkReplyHttpImpl::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkReplyHttpImplENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkReplyHttpImplENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkReplyHttpImplENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QNetworkReplyHttpImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QNetworkReplyHttpImpl::startHttpRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkReplyHttpImpl::*)();
            if (_t _q_method = &QNetworkReplyHttpImpl::abortHttpRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkReplyHttpImpl::readBufferSizeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkReplyHttpImpl::*)(qint64 );
            if (_t _q_method = &QNetworkReplyHttpImpl::readBufferFreed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QNetworkReplyHttpImpl::*)();
            if (_t _q_method = &QNetworkReplyHttpImpl::startHttpRequestSynchronously; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkReplyHttpImpl::haveUploadData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
void *QNetworkReplyHttpImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkReplyHttpImplENDCLASS.stringdata0))
