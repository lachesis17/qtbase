...
struct qt_meta_stringdata_CLASSQHttpMultiPartENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQHttpMultiPartENDCLASS = QtMocHelpers::stringData(
    "QHttpMultiPart"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQHttpMultiPartENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QHttpMultiPart::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQHttpMultiPartENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQHttpMultiPartENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQHttpMultiPartENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QHttpMultiPart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQHttpMultiPartENDCLASS.stringdata0))
