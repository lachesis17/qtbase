...
struct qt_meta_stringdata_CLASSQDnsTlsAssociationRecordENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQDnsTlsAssociationRecordENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQDnsTlsAssociationRecordENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QDnsTlsAssociationRecord::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_CLASSQDnsTlsAssociationRecordENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQDnsTlsAssociationRecordENDCLASS,
    nullptr,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQDnsTlsAssociationRecordENDCLASS_t,
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQDnsLookupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQDnsLookupENDCLASS = QtMocHelpers::stringData(
    "QDnsLookup",
    "finished",
    "",
    "nameChanged",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQDnsLookupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QDnsLookup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQDnsLookupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQDnsLookupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQDnsLookupENDCLASS_t,
        // property 'error'
...
void QDnsLookup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QDnsLookup::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QDnsLookup::nameChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QDnsLookup::*)(QDnsLookup::Type );
            if (_t _q_method = &QDnsLookup::typeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QDnsLookup::nameserverChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QDnsLookup::*)(quint16 );
            if (_t _q_method = &QDnsLookup::nameserverPortChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QDnsLookup::*)(QDnsLookup::Protocol );
            if (_t _q_method = &QDnsLookup::nameserverProtocolChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
void *QDnsLookup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQDnsLookupENDCLASS.stringdata0))
