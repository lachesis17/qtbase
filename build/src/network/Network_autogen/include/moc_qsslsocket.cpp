...
struct qt_meta_stringdata_CLASSQSslSocketENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQSslSocketENDCLASS = QtMocHelpers::stringData(
    "QSslSocket",
    "encrypted",
    "",
    "peerVerifyError",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQSslSocketENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QSslSocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQSslSocketENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQSslSocketENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQSslSocketENDCLASS_t,
        // enum 'SslMode'
...
void QSslSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QSslSocket::*)();
            if (_t _q_method = &QSslSocket::encrypted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(const QSslError & );
            if (_t _q_method = &QSslSocket::peerVerifyError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(const QList<QSslError> & );
            if (_t _q_method = &QSslSocket::sslErrors; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(QSslSocket::SslMode );
            if (_t _q_method = &QSslSocket::modeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(qint64 );
            if (_t _q_method = &QSslSocket::encryptedBytesWritten; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(QSslPreSharedKeyAuthenticator * );
            if (_t _q_method = &QSslSocket::preSharedKeyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)();
            if (_t _q_method = &QSslSocket::newSessionTicketReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(QSsl::AlertLevel , QSsl::AlertType , const QString & );
            if (_t _q_method = &QSslSocket::alertSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(QSsl::AlertLevel , QSsl::AlertType , const QString & );
            if (_t _q_method = &QSslSocket::alertReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (QSslSocket::*)(const QSslError & );
            if (_t _q_method = &QSslSocket::handshakeInterruptedOnError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
...
void *QSslSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQSslSocketENDCLASS.stringdata0))
