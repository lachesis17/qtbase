...
struct qt_meta_stringdata_CLASSQNetworkAccessFileBackendENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkAccessFileBackendENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkAccessFileBackendENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkAccessFileBackend::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkAccessFileBackendENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkAccessFileBackendENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkAccessFileBackendENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QNetworkAccessFileBackend::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkAccessFileBackendENDCLASS.stringdata0))
