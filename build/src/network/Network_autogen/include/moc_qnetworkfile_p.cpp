...
struct qt_meta_stringdata_CLASSQNetworkFileENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkFileENDCLASS = QtMocHelpers::stringData(
    "QNetworkFile",
    "finished",
    "",
    "ok",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkFileENDCLASS[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, 0x80000000 | 8, QMetaType::QString,    7,    9,
...
Q_CONSTINIT const QMetaObject QNetworkFile::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkFileENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkFileENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkFileENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QNetworkFile, std::true_type>,
        // method 'finished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'headerRead'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QHttpHeaders::WellKnownHeader, std::false_type>,
...
void QNetworkFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QNetworkFile::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkFile::*)(QHttpHeaders::WellKnownHeader , const QByteArray & );
            if (_t _q_method = &QNetworkFile::headerRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkFile::error; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QNetworkFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkFileENDCLASS.stringdata0))
