...
struct qt_meta_stringdata_CLASSQNetworkDiskCacheENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkDiskCacheENDCLASS = QtMocHelpers::stringData(
    "QNetworkDiskCache",
    "clear",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkDiskCacheENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkDiskCache::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkDiskCacheENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkDiskCacheENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkDiskCacheENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QNetworkDiskCache, std::true_type>,
        // method 'clear'
...
void *QNetworkDiskCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkDiskCacheENDCLASS.stringdata0))
