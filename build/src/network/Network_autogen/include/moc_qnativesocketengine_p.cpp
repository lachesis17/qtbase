...
struct qt_meta_stringdata_CLASSQNativeSocketEngineENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNativeSocketEngineENDCLASS = QtMocHelpers::stringData(
    "QNativeSocketEngine",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNativeSocketEngineENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNativeSocketEngine::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractSocketEngine::staticMetaObject>(),
    qt_meta_stringdata_CLASSQNativeSocketEngineENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNativeSocketEngineENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNativeSocketEngineENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QNativeSocketEngine, std::true_type>,
...
void *QNativeSocketEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNativeSocketEngineENDCLASS.stringdata0))
