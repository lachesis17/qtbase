...
struct qt_meta_stringdata_CLASSQNetworkReplyImplENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkReplyImplENDCLASS = QtMocHelpers::stringData(
    "QNetworkReplyImpl",
    "_q_startOperation",
    "",
    "_q_copyReadyRead",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkReplyImplENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkReplyImpl::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkReplyImplENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkReplyImplENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkReplyImplENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QNetworkReplyImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkReplyImplENDCLASS.stringdata0))
