...
struct qt_meta_stringdata_CLASSQNetworkAccessManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQNetworkAccessManagerENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQNetworkAccessManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QNetworkAccessManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQNetworkAccessManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQNetworkAccessManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQNetworkAccessManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QNetworkAccessManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QNetworkAccessManager::proxyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkAccessManager::authenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QNetworkAccessManager::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)(QNetworkReply * );
            if (_t _q_method = &QNetworkAccessManager::encrypted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)(QNetworkReply * , const QList<QSslError> & );
            if (_t _q_method = &QNetworkAccessManager::sslErrors; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)(QNetworkReply * , QSslPreSharedKeyAuthenticator * );
            if (_t _q_method = &QNetworkAccessManager::preSharedKeyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
void *QNetworkAccessManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQNetworkAccessManagerENDCLASS.stringdata0))
