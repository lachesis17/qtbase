...
struct qt_meta_stringdata_CLASSQHostInfoResultENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQHostInfoResultENDCLASS = QtMocHelpers::stringData(
    "QHostInfoResult",
    "resultsReady",
    "",
    "QHostInfo",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQHostInfoResultENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QHostInfoResult::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQHostInfoResultENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQHostInfoResultENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQHostInfoResultENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QHostInfoResult::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QHostInfoResult::resultsReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QHostInfoResult::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQHostInfoResultENDCLASS.stringdata0))
