...
struct qt_meta_stringdata_CLASSQHttpNetworkReplyENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQHttpNetworkReplyENDCLASS = QtMocHelpers::stringData(
    "QHttpNetworkReply",
    "encrypted",
    "",
    "sslErrors",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQHttpNetworkReplyENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QHttpNetworkReply::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQHttpNetworkReplyENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQHttpNetworkReplyENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQHttpNetworkReplyENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QHttpNetworkReply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QHttpNetworkReply::encrypted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(const QList<QSslError> & );
            if (_t _q_method = &QHttpNetworkReply::sslErrors; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(QSslPreSharedKeyAuthenticator * );
            if (_t _q_method = &QHttpNetworkReply::preSharedKeyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (_t _q_method = &QHttpNetworkReply::socketStartedConnecting; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (_t _q_method = &QHttpNetworkReply::requestSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (_t _q_method = &QHttpNetworkReply::readyRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (_t _q_method = &QHttpNetworkReply::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QHttpNetworkReply::finishedWithError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (_t _q_method = &QHttpNetworkReply::headerChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QHttpNetworkReply::dataReadProgress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(qint64 , qint64 );
            if (_t _q_method = &QHttpNetworkReply::dataSendProgress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 11;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QHttpNetworkReply::cacheCredentials; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 12;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QHttpNetworkReply::proxyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 13;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(const QHttpNetworkRequest & , QAuthenticator * );
            if (_t _q_method = &QHttpNetworkReply::authenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 14;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QHttpNetworkReply::redirected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 15;
                return;
            }
        }
...
void *QHttpNetworkReply::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQHttpNetworkReplyENDCLASS.stringdata0))
