...
struct qt_meta_stringdata_CLASSQSslServerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQSslServerENDCLASS = QtMocHelpers::stringData(
    "QSslServer",
    "sslErrors",
    "",
    "QSslSocket*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQSslServerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QSslServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQSslServerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQSslServerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQSslServerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QSslServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QSslServer::sslErrors; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * , const QSslError & );
            if (_t _q_method = &QSslServer::peerVerifyError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * , QAbstractSocket::SocketError );
            if (_t _q_method = &QSslServer::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * , QSslPreSharedKeyAuthenticator * );
            if (_t _q_method = &QSslServer::preSharedKeyAuthenticationRequired; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * , QSsl::AlertLevel , QSsl::AlertType , const QString & );
            if (_t _q_method = &QSslServer::alertSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * , QSsl::AlertLevel , QSsl::AlertType , const QString & );
            if (_t _q_method = &QSslServer::alertReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * , const QSslError & );
            if (_t _q_method = &QSslServer::handshakeInterruptedOnError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QSslServer::*)(QSslSocket * );
            if (_t _q_method = &QSslServer::startedEncryptionHandshake; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
void *QSslServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQSslServerENDCLASS.stringdata0))
