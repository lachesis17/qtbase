...
struct qt_meta_stringdata_CLASSQHttpSocketEngineENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQHttpSocketEngineENDCLASS = QtMocHelpers::stringData(
    "QHttpSocketEngine",
    "slotSocketConnected",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQHttpSocketEngineENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QHttpSocketEngine::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQHttpSocketEngineENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQHttpSocketEngineENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQHttpSocketEngineENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QHttpSocketEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQHttpSocketEngineENDCLASS.stringdata0))
