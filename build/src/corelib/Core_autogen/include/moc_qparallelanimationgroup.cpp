...
struct qt_meta_stringdata_CLASSQParallelAnimationGroupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQParallelAnimationGroupENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQParallelAnimationGroupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QParallelAnimationGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQParallelAnimationGroupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQParallelAnimationGroupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQParallelAnimationGroupENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QParallelAnimationGroup, std::true_type>,
...
void *QParallelAnimationGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQParallelAnimationGroupENDCLASS.stringdata0))
