...
struct qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQWindowsFileSystemWatcherEngineENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QWindowsFileSystemWatcherEngine::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQWindowsFileSystemWatcherEngineENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QWindowsFileSystemWatcherEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QWindowsFileSystemWatcherEngine::driveLockForRemoval; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QWindowsFileSystemWatcherEngine::*)(const QString & );
            if (_t _q_method = &QWindowsFileSystemWatcherEngine::driveLockForRemovalFailed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QWindowsFileSystemWatcherEngine::*)(const QString & );
            if (_t _q_method = &QWindowsFileSystemWatcherEngine::driveRemoved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QWindowsFileSystemWatcherEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QWindowsFileSystemWatcherEngineThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QWindowsFileSystemWatcherEngineThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QWindowsFileSystemWatcherEngineThread::fileChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QWindowsFileSystemWatcherEngineThread::*)(const QString & , bool );
            if (_t _q_method = &QWindowsFileSystemWatcherEngineThread::directoryChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQWindowsFileSystemWatcherEngineThreadENDCLASS.stringdata0))
        return static_cast<void*>(this);
