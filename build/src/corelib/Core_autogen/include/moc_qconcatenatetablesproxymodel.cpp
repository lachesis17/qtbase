...
struct qt_meta_stringdata_CLASSQConcatenateTablesProxyModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQConcatenateTablesProxyModelENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQConcatenateTablesProxyModelENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       1,    1,   26,    2, 0x42,    1 /* Public | isScriptable */,
       5,    1,   29,    2, 0x42,    3 /* Public | isScriptable */,
...
Q_CONSTINIT const QMetaObject QConcatenateTablesProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQConcatenateTablesProxyModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQConcatenateTablesProxyModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQConcatenateTablesProxyModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QConcatenateTablesProxyModel, std::true_type>,
...
void *QConcatenateTablesProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQConcatenateTablesProxyModelENDCLASS.stringdata0))
