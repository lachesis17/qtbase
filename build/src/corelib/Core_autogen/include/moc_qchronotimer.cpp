...
struct qt_meta_stringdata_CLASSQChronoTimerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQChronoTimerENDCLASS = QtMocHelpers::stringData(
    "QChronoTimer",
    "timeout",
    "",
    "start",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQChronoTimerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QChronoTimer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQChronoTimerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQChronoTimerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQChronoTimerENDCLASS_t,
        // property 'singleShot'
...
void QChronoTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QChronoTimer::*)(QPrivateSignal);
            if (_t _q_method = &QChronoTimer::timeout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QChronoTimer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQChronoTimerENDCLASS.stringdata0))
