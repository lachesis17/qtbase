...
struct qt_meta_stringdata_CLASSQAnimationGroupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQAnimationGroupENDCLASS = QtMocHelpers::stringData(
    "QAnimationGroup"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQAnimationGroupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QAnimationGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQAnimationGroupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQAnimationGroupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQAnimationGroupENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QAnimationGroup, std::true_type>
    >,
    nullptr
} };
...
void *QAnimationGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQAnimationGroupENDCLASS.stringdata0))
