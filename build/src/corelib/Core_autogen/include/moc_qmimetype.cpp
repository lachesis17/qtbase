...
struct qt_meta_stringdata_CLASSQMimeTypeENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQMimeTypeENDCLASS = QtMocHelpers::stringData(
    "QMimeType",
    "inherits",
    "",
    "mimeTypeName",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQMimeTypeENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QMimeType::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_CLASSQMimeTypeENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQMimeTypeENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQMimeTypeENDCLASS_t,
        // property 'valid'
