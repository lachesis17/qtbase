...
struct qt_meta_stringdata_CLASSQWindowsPipeWriterENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQWindowsPipeWriterENDCLASS = QtMocHelpers::stringData(
    "QWindowsPipeWriter",
    "bytesWritten",
    "",
    "bytes",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQWindowsPipeWriterENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QWindowsPipeWriter::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQWindowsPipeWriterENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQWindowsPipeWriterENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQWindowsPipeWriterENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QWindowsPipeWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QWindowsPipeWriter::*)(qint64 );
            if (_t _q_method = &QWindowsPipeWriter::bytesWritten; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QWindowsPipeWriter::*)();
            if (_t _q_method = &QWindowsPipeWriter::writeFailed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QWindowsPipeWriter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQWindowsPipeWriterENDCLASS.stringdata0))
