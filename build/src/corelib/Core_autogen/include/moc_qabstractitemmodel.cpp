...
constexpr auto qt_meta_stringdata_CLASSQAbstractItemModelENDCLASS = QtMocHelpers::stringData(
    "QAbstractItemModel",
    "dataChanged",
    "",
    "QModelIndex",
...
constexpr auto qt_meta_stringdata_CLASSQAbstractTableModelENDCLASS = QtMocHelpers::stringData(
    "QAbstractTableModel"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
constexpr auto qt_meta_stringdata_CLASSQAbstractListModelENDCLASS = QtMocHelpers::stringData(
    "QAbstractListModel"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
