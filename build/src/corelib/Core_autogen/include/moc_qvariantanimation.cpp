...
struct qt_meta_stringdata_CLASSQVariantAnimationENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQVariantAnimationENDCLASS = QtMocHelpers::stringData(
    "QVariantAnimation",
    "valueChanged",
    "",
    "QVariant",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQVariantAnimationENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       1,    1,   20,    2, 0x06,    6 /* Public */,

 // signals: parameters
    QMetaType::Void, 0x80000000 | 3,    4,

 // properties: name, type, flags, notifyId, revision
       5, 0x80000000 | 3, 0x0001510b, uint(-1), 0,
       6, 0x80000000 | 3, 0x0001510b, uint(-1), 0,
       7, 0x80000000 | 3, 0x00015009, uint(0), 0,
       8, QMetaType::Int, 0x02015103, uint(-1), 0,
...
Q_CONSTINIT const QMetaObject QVariantAnimation::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQVariantAnimationENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQVariantAnimationENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQVariantAnimationENDCLASS_t,
        // property 'startValue'
        ...
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QVariantAnimation, std::true_type>,
        // method 'valueChanged'
...
void QVariantAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QVariantAnimation::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QVariantAnimation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQVariantAnimationENDCLASS.stringdata0))
