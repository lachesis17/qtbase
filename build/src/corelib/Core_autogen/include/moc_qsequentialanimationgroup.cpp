...
struct qt_meta_stringdata_CLASSQSequentialAnimationGroupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQSequentialAnimationGroupENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQSequentialAnimationGroupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QSequentialAnimationGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQSequentialAnimationGroupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQSequentialAnimationGroupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQSequentialAnimationGroupENDCLASS_t,
...
void QSequentialAnimationGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QSequentialAnimationGroup::currentAnimationChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QSequentialAnimationGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQSequentialAnimationGroupENDCLASS.stringdata0))
