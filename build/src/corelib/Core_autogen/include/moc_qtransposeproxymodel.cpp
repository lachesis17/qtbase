...
struct qt_meta_stringdata_CLASSQTransposeProxyModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQTransposeProxyModelENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQTransposeProxyModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QTransposeProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQTransposeProxyModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQTransposeProxyModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQTransposeProxyModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QTransposeProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQTransposeProxyModelENDCLASS.stringdata0))
