...
struct qt_meta_stringdata_CLASSQPropertyAnimationENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQPropertyAnimationENDCLASS = QtMocHelpers::stringData(
    "QPropertyAnimation",
    "propertyName",
    "targetObject"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQPropertyAnimationENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QPropertyAnimation::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQPropertyAnimationENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQPropertyAnimationENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQPropertyAnimationENDCLASS_t,
...
void *QPropertyAnimation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQPropertyAnimationENDCLASS.stringdata0))
