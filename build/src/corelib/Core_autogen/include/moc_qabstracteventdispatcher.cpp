...
constexpr auto qt_meta_stringdata_CLASSQAbstractEventDispatcherENDCLASS = QtMocHelpers::stringData(
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQAbstractEventDispatcherV2ENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQAbstractEventDispatcherV2ENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQAbstractEventDispatcherV2ENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QAbstractEventDispatcherV2::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQAbstractEventDispatcherV2ENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQAbstractEventDispatcherV2ENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQAbstractEventDispatcherV2ENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QAbstractEventDispatcherV2, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQAbstractEventDispatcherV2ENDCLASS.stringdata0))
        return static_cast<void*>(this);
