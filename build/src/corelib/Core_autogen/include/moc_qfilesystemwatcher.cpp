...
struct qt_meta_stringdata_CLASSQFileSystemWatcherENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQFileSystemWatcherENDCLASS = QtMocHelpers::stringData(
    "QFileSystemWatcher",
    "fileChanged",
    "",
    "path",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQFileSystemWatcherENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QFileSystemWatcher::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQFileSystemWatcherENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQFileSystemWatcherENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQFileSystemWatcherENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QFileSystemWatcher, std::true_type>,
        // method 'fileChanged'
...
void QFileSystemWatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QFileSystemWatcher::fileChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QFileSystemWatcher::*)(const QString & , QPrivateSignal);
            if (_t _q_method = &QFileSystemWatcher::directoryChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QFileSystemWatcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQFileSystemWatcherENDCLASS.stringdata0))
