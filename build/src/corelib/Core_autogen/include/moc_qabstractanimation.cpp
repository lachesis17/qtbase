...
struct qt_meta_stringdata_CLASSQAbstractAnimationENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQAbstractAnimationENDCLASS = QtMocHelpers::stringData(
    "QAbstractAnimation",
    "finished",
    "",
    "stateChanged",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQAbstractAnimationENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QAbstractAnimation::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQAbstractAnimationENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQAbstractAnimationENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQAbstractAnimationENDCLASS_t,
        // property 'state'
...
void QAbstractAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QAbstractAnimation::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QAbstractAnimation::stateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QAbstractAnimation::currentLoopChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QAbstractAnimation::directionChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *QAbstractAnimation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQAbstractAnimationENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQAnimationDriverENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQAnimationDriverENDCLASS = QtMocHelpers::stringData(
    "QAnimationDriver",
    "started",
    "",
    "stopped"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQAnimationDriverENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QAnimationDriver::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSQAnimationDriverENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQAnimationDriverENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQAnimationDriverENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void QAnimationDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QAnimationDriver::started; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QAnimationDriver::*)();
            if (_t _q_method = &QAnimationDriver::stopped; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQAnimationDriverENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
